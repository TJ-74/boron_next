      ...
      {!isEditing ? (
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-start gap-6 mb-6">
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 rounded-2xl overflow-hidden bg-white border-4 border-white shadow-xl">
                    ...
                    <label className="absolute -bottom-1 -right-1 bg-gradient-to-r from-blue-600 to-purple-600 text-white p-2.5 rounded-xl cursor-pointer hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:scale-110">
                      <input
                        ref={fileInputRef}
                        type="file"
                        className="hidden"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-lg text-gray-600 mb-3">{profile.title || 'Add your title'}</p>

                    <button
                      onClick={() => setIsEditing(true)}
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all font-medium text-xs shadow-sm"
                    >
                ...
                <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                  ...
                  <div className="space-y-3">
                    <label className="block">
                      <div className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl cursor-pointer hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl font-semibold text-sm">
                        {isResumeUploading ? (
                          <>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-green-300 text-green-700 rounded-xl hover:bg-green-50 transition-all font-semibold text-sm shadow-sm"
                    >
                    ...
                    {onViewPdf && (
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-red-300 text-red-700 rounded-xl hover:bg-red-50 transition-all font-semibold text-sm shadow-sm"
                      >
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              onClick={handleSave}
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all font-semibold disabled:opacity-50"
