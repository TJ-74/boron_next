      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-gray-400">Showcase your career journey</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl shadow-2xl border border-white/10 p-4 sm:p-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4 border-t border-white/10">
              ...
              <button
                onClick={handleAdd}
                className="inline-flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-600 via-fuchsia-500 to-cyan-500 text-white rounded-lg hover:shadow-lg hover:shadow-purple-500/50 transition-all font-medium text-xs sm:text-sm disabled:opacity-50 w-full sm:w-auto"
                disabled={isLoading || !newExperience.company || !newExperience.position}
              >
                <Save className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                <span className="hidden sm:inline">{isLoading ? 'Saving...' : 'Save Experience'}</span>
                  ...
                  <div className="rounded-2xl shadow-2xl border border-white/10 p-4 sm:p-6">
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4 border-t border-white/10">
                        ...
                        >
                          <Save className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                          <span className="hidden sm:inline">{isLoading ? 'Saving...' : 'Update Experience'}</span>
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-3 sm:gap-0 mb-4">
                        <div className="flex items-start gap-3 sm:gap-4 flex-1 min-w-0 w-full sm:w-auto">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-base sm:text-lg text-gray-300 font-medium mb-2 break-words">{experience.company}</p>
                            <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-400">
                              ...
                              <span className="flex items-center gap-1">
                                ...
                                <span className="break-words">{formatDateRange(experience.startDate, experience.endDate)}</span>
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1 self-start sm:self-auto ml-auto sm:ml-0">
                          ...
                          <button
                            ...
                            className="p-2 sm:p-2 rounded-lg text-gray-400 bg-white/5 backdrop-blur-xl hover:text-purple-400 hover:bg-purple-500/10 transition-all"
                            disabled={isLoading}
                          >
                          ...
                          <button
                            ...
                            className="p-2 sm:p-2 rounded-lg text-gray-400 bg-white/5 backdrop-blur-xl hover:text-red-400 hover:bg-red-500/10 transition-all"
                            disabled={isLoading}
                          >
