    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button 
                ...
                className="bg-blue-600 hover:bg-blue-700"
                disabled={isLoading || !editingProject.title.trim() || !editingProject.description.trim() || !editingProject.technologies.trim()}
              >
                <Save className="h-4 w-4 mr-2" />
                {isLoading ? 'Saving...' : 'Save'}
              </Button>
      ...
      <div className="space-y-6 mt-6">
        {projects.length === 0 ? (
          ...
          <div className="space-y-6">
            {projects
              .filter(project => !editingProject || project.id !== editingProject.id)
              .map((project) => (
                <div 
                  key={project.id} 
                  className={`bg-gray-800/70 rounded-lg p-6 border border-gray-700 hover:border-blue-500 transition-colors ${project.includeInResume === false ? 'opacity-60' : ''}`}
                >
